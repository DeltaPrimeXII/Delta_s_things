...
class Engine:
    ...
    def __init__(self):
        ...
        def on_key_press(symbol, modifiers):
            self.objects.append(Ball(randint(100, 500), randint(100, 500), randint(25, 50), self, Vector2(10, 0)))
            self.objects.append(Ball(randint(100, 500), randint(100, 500), randint(25, 50), self, Vector2(20, 0)))
